...
final class AreaDistrictTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    public function datasource(): Builder
    {
        return District::query()
            ...
            ->where('regency_id', $this->regency->id)
            ->select(
                'area_districts.*',
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('id')
            ->addColumn('name')
            ->addColumn('name_lower', fn (District $model) => strtolower(e($model->name)))
